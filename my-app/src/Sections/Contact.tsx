    ...
    <div className="flex flex-col justify-end">
      ...
      <div>
            ...
            >
              <div className="w-max bg-accent-blue rounded-full hover:cursor-pointer hover:bg-headline-gray">
                <img
                  ...
                  alt="Linkedin Logo"
                  className="w-12 p-3 md:w-8 md:p-2"
                />
              </div>
            </a>
          </div>
        ...
        <div className="text-center">
          <p className="font-cairo font-extralight text-lg md:text-xl lg:text-2xl">
            Giamela Mediation
          </p>
          <br />
          <p className="font-cairo font-extralight text-lg md:text-xl lg:text-2xl">
          ...
          <br />
          <a
            className="font-cairo font-extralight text-lg md:text-xl lg:text-2xl"
